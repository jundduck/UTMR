...
| AWSIM dynamic TF smoke | 1 episode | observed row + 693 step rows | route success 0% | live pipeline smoke, benchmark 아님 |
...
| Episode row | observed metric row 생성 |
| Collision | `False` |
| Success | `False` |
| Timeout | `True` |
| Route length | `20.25 m` |
| Driving score | `0.0` |
