...
_DEFAULT_WOTE_ROOT = Path(__file__).resolve().parents[4]
_WOTE_ROOT = os.environ.get("NAVSIM_DEVKIT_ROOT", str(_DEFAULT_WOTE_ROOT)).rstrip("/")
...
class WoTEConfig:
    ...
    resnet34_path = f"{_WOTE_ROOT}/ckpts/resnet34.pth"
    ...
    sim_reward_dict_path: str = f"{_WOTE_ROOT}/dataset/extra_data/planning_vb/formatted_pdm_score_{num_traj_anchor}.npy"
    cluster_file_path: str = f"{_WOTE_ROOT}/dataset/extra_data/planning_vb/trajectory_anchors_{num_traj_anchor}.npy"
    ...
    # UTMR selection diagnostics. This keeps the original WoTE behavior off by default.
    use_utmr: bool = False
    utmr_beta: float = 1.0
    utmr_gamma_h: float = 0.75
    utmr_gamma_m: float = 0.05
    utmr_top_n: int = 8
    utmr_min_nc: float = 0.5
    utmr_min_ttc_score: float = 0.5
    utmr_fine_im_weight: float = 0.0
    utmr_fine_nc_weight: float = 1.0
    utmr_fine_dac_weight: float = 1.0
    utmr_fine_ep_weight: float = 0.5
    utmr_fine_ttc_weight: float = 1.0
    utmr_fine_comfort_weight: float = 0.5
    utmr_fine_margin_min: float = 0.0
    utmr_max_coarse_drop: float = 1000000000.0
    utmr_uniform_fine: bool = False
    utmr_step_log_path: str = ""
